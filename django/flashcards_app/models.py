...
class FlashcardList(models.Model):
    ...
    created_by_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="flashcardlists")
...
class Flashcard(models.Model):
    ...
    created_by_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="flashcards")

    # Points to the FlashcardList that has this Flashcard.
    flashcard_list = models.ForeignKey(FlashcardList, on_delete=models.CASCADE, related_name="flashcards")
